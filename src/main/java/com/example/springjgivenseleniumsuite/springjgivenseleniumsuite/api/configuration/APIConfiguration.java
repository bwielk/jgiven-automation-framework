package com.example.springjgivenseleniumsuite.springjgivenseleniumsuite.api.configuration;
...
@Configuration
@EnableFeignClients(basePackages = {"com.example.springjgivenseleniumsuite.springjgivenseleniumsuite.api.clients"})
